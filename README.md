...
base_model_to_Ali.ipynb: Turn MATH into JSONL format
convert_math_dataset_to_json.py: Include info about levels and type in JSON for MATH
*.jsonl and *.json: Processed datasets in different formats